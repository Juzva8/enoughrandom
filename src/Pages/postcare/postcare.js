    ...
    return (
      ...
      <div className="row">
        <div className="col-12 col-lg-7 pl-lg-0 pr-lg-5">
          ...
          <h4><strong>Things You Should Avoid for at least 24 hours - BEFORE THE PROCEDURE</strong></h4>
          <h5 >Alcohol, caffeine, Ibuprofen/Advil, Aspirin, Vitamin E, “Hair, Skin, Nail” supplements, and fish oil supplements.</h5>
          <h4>1 week - BEFORE THE PROCEDURE</h4>
          <h5 >Avoid sun and tanning also brow waxing, tinting, or threading.</h5>
          <h4>Stop using 2 weeks - BEFORE THE PROCEDURE</h4>
          <h5 >Alpha Hydroxy Acid (AHA) products close to the eyebrow area.</h5>
          <h4>Stop using at least 1 month - BEFORE THE PROCEDURE</h4>
          <h5>Retinol or vitamin A products,  chemical Peels, Microdermabrasion and facials.</h5>
      ...
      <Zoom>
        ...
        <h3>AFTER THE PROCEDURE</h3>
          <h4><strong> Day 1 – 2</strong></h4>
          <h5 >Use a clean tissue every few hours to pick up the clear fluid that is coming out. This will help reduce scabbing. The fluid forms the scabs.</h5>
          <h4>Day 1 – 10</h4>
          <h5 >Starting on the night of your procedure, wash your brows every morning and evening with antibacterial soap with your pointer finger in a circular motion. 
