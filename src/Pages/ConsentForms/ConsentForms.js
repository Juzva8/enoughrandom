...
function ConsentForms() {
    ...
    return (
        <div className="ConsentForms">
            ...
            <span className="ConsentForm__span">SUBMIT A $50 NON-REFUNDABLE BOOKING FEE TO RESERVE YOUR APPOINTMENT. THIS FEE WILL GO TOWARDS YOUR SERVICE OR PROCEDURE PRICING.<br/> PLEASE SEND IT USING <strong>ZELLE AT BROWSJUNGLE@GMAIL.COM</strong> IF PAYMENT IS NOT RECEIVED WITHIN 1 HOUR BOOKING WILL BE CANCELLED. </span>
